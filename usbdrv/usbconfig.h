 ...
 */
#define USB_CFG_VENDOR_NAME     'p', 'i', 's', 'a', 'k', '.', 'o', 'r', 'g'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'p', 'i', 's', 'a', 'k', '-', 's', 'w', 'i', 't', 'c', 'h'
 ...
 */
#define USB_CFG_DEVICE_CLASS        3    /* set to 0 if deferred to interface */
